 ...
 * @date 2022/11/24
 */
public class ConnectionRestRequestHandler
    implements ServerRequestHandler<ConnectionSetupRequest, ConnectResetResponse> {

  @Override
  public ConnectResetResponse requestReply(
      ConnectionSetupRequest request, GrpcConnection grpcConn) {
