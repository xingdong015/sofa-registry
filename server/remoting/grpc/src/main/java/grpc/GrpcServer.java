...
public class GrpcServer implements Server {
    ...
    private io.grpc.Server newGrpcServer() {
        ServerBuilder<?> serverBuilder = ServerBuilder.forPort(url.getPort()).executor(newCachedThreadPool())
        ...
        for (BindableService bindableService : definitions) {
            serverBuilder.addService(bindableService).addService(ServerInterceptors.intercept(bindableService, new ServerInterceptor() {
                @Override
